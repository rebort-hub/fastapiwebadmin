<template>
  <svg aria-hidden="true" class="oauth-icon" fill="currentColor" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
    <path
...
<script setup lang="ts">defineOptions({ name: 'GithubIcon' })
</script>
