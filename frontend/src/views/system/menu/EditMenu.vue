          ...
          <template v-if="state.form.menu_type === 10">
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
              <el-form-item label="权限标识">
                <el-input v-model="state.form.roles" placeholder="请输入权限标识，如：admin,user" clearable></el-input>
              </el-form-item>
            </el-col>
          </template>
          <el-col v-if="state.form.menu_type === 20" :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="权限标识">
              <el-input v-model="state.form.roles" placeholder="请输入按钮权限标识" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
...
const openDialog = (editType: string, row: any) => {
  ...
  if (row) {
    ...
    // 修复 roles 字段：如果是 0、false、'0'、'False'，转换为空字符串
    if (!state.form.roles || state.form.roles === 0 || state.form.roles === '0' || state.form.roles === 'False') {
      state.form.roles = '';
    }
  } else {
