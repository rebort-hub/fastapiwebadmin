<template>
  <div v-show="state.isShowLockScreen">
    ...
    <div class="layout-lock-screen-img" 
         :class="{ 'layout-lock-screen-filter': state.isShowLockLogin }"
         :style="{ backgroundImage: `url(${backgroundImages.lockScreenBg})` }"></div>
    <div class="layout-lock-screen">
      ...
      >
        ...
        <div class="layout-lock-screen-date-top" style=" right: 90px;" @click="hideLockScreenPage">
          <MousePointerClick/>
          <div class="layout-lock-screen-date-top-text">点击解锁</div>
        </div>
      </div>
      <transition name="el-zoom-in-center">
        <div v-if="state.isShowLockLogin" class="layout-lock-screen-login">
          <div class="layout-lock-screen-login-box">
              ...
              <el-form :model="state">
                <el-form-item prop="lockScreenPassword"
                  ...
                  >
                    ...
                    <!--                  &lt;!&ndash;                  <el-button @click="onLockScreenSubmit">&ndash;&gt;-->
                    <!--                  &lt;!&ndash;                    <el-icon class="el-input__icon">&ndash;&gt;-->
                    <!--                  &lt;!&ndash;                      <ele-Right/>&ndash;&gt;-->
                    <!--                  &lt;!&ndash;                    </el-icon>&ndash;&gt;-->
            ...
            <div class="layout-lock-screen-login-box-value">
              <el-button class="w100" type="primary" size="default" @click="onLockScreenSubmit">
                进入系统
              </el-button>
            </div>
            <div class="layout-lock-screen-login-box-value mt8 mb8">
              <el-button class="w100" text="plain" type="info" size="default" @click="returnLogin">
                返回登录
              </el-button>
            </div>
            <div class="layout-lock-screen-login-box-value">
              <el-button class="w100" text="plain" type="info" size="default" @click="onBack">
                返回
              </el-button>
            </div>
          </div>
...
import { MousePointerClick, MoveUp } from "/@/icons"
import { backgroundImages } from '/@/config/assets';
...
// 隐藏锁屏页面
const hideLockScreenPage = () => {
  state.isShowLockLogin = true;
  nextTick(() => {
    (<HTMLElement> state.querySelectorEl).setAttribute('style', `top:-1000px;opacity:1;transition:all 0.3s ease;`);
  });
};
